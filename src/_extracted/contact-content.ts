...
export const CONTACT_CARDS: ContactCard[] = [
  ...
  { icon: 'whatsapp', label: 'WhatsApp', value: '+1 (937) 772-2944', href: `https://wa.me/19377722944?text=${encodeURIComponent("Hi Media Pro, I'd like to discuss a project.")}`, external: true },
